...
public class ListaUsuario extends javax.swing.JFrame {
    ...
    public void preencherTabela() {
        ...
        String[] colunas = new String[]{"Usuário", "Perfil"};
        rs = dao.localizarUsuarios();
        try {
            rs.first();
            do {
                dados.add(new Object[]{rs.getString("login"), rs.getString("perfil")});
            } while (rs.next());
