 ...
 * @author maico
 */
public class GeraEstorno extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Gerar Estorno de Venda");
        ...
        jLabel23.setText("Status da Venda:");
        ...
        lblDescricao.setText("Observação:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GeraEstorno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GeraEstorno().setVisible(true);
            }
        });
    }
